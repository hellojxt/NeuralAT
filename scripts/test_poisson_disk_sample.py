...
# compare
plot_point_cloud(sound_object.vertices, sound_object.triangles, sampler.points, mesh_opacity=1.0, cmin =-1,cmax=1).show()
...
plot_point_cloud(sound_object.vertices, sound_object.triangles, points, mesh_opacity=1.0, cmin =-1, cmax=1).show()
