    ...
    def __init__(self, vertices, triangles, res=32):
        ...
        if triangles is None:
            ...
            cuda_voxelizer(
                ...
                np.int32(res),
                drv.In(vertices.astype(np.float32)),
                drv.In(triangles.astype(np.int32)),
